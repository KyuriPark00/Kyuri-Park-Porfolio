...
$lastid = $connection->lastInsertID(); // Gets the id of the last insserted  record
...
//new insert query for media table, with filename and the foreign key

//new INSERT query for media table, with the filename and the foreign key
// "INSERT INTO projects (title,description,image_url,project_id) VALUES (?,?,?,?)";
